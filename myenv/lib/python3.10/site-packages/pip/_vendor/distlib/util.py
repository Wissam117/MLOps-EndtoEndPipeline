...
class ExportEntry(object):
    ...
    def __eq__(self, other):
        if not isinstance(other, ExportEntry):
            ...
            result = (self.name == other.name and self.prefix
                      == other.prefix and self.suffix == other.suffix and self.flags == other.flags)
        return result
            ...
            if 'distutils' in sections:
                ...
                if _servers == []:
                    ...
                    for server in _servers:
                        ...
                        # optional params
                        for key, default in (
                                ('repository', self.DEFAULT_REPOSITORY), ('realm', self.DEFAULT_REALM), ('password', None)):
