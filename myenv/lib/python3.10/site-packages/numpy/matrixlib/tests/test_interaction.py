...
def test_sort_matrix_none():
    ...
    assert_(isinstance(expected, np.matrix))
...
def test_iter_allocate_output_subtype():
    ...
    assert_(isinstance(i.operands[2], np.matrix))
    assert_(not isinstance(i.operands[2], np.ndarray))
    ...
    assert_(isinstance(i.operands[2], np.ndarray))
    assert_(not isinstance(i.operands[2], np.matrix))
...
def like_function():
    ...
    for like_function in np.zeros_like, np.ones_like, np.empty_like:
        ...
        assert_(not isinstance(c, np.matrix))
...
def test_array_astype():
    ...
    assert_equal(a, b)
    assert_(not (a is b))
    assert_(not isinstance(b, np.matrix))
