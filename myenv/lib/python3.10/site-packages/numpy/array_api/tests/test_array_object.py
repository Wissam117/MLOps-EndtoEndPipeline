            ...
            for _op in ops:
                for a in _array_vals():
                    ...
                    if ((dtypes == "all"
                        ...
                        # isinstance here.
                        and (a.dtype in _boolean_dtypes and isinstance(s, bool)
                             or a.dtype in _integer_dtypes and isinstance(s, int)
                ...
                for _op in ops:
                    for x in _array_vals():
                        for y in _array_vals():
                            ...
                            # Ensure in-place operators only promote to the same dtype as the left
                            # operand.
                            elif (
                                _op.startswith("__i")
                                ...
                                assert_raises(TypeError, lambda: getattr(x, _op)(y))
                            # Ensure only those dtypes that are required for every operator are
                            # allowed.
        ...
        for s in [1, 1.0, False]:
            for a in _matmul_array_vals():
                if (type(s) in [float, int] and a.dtype in _floating_dtypes
                        or isinstance(s, int) and a.dtype in _integer_dtypes):
